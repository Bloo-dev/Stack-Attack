...
tellraw @s ["",{"text":"Stack Attack 1.16, Snapshot 0517 - ","color":"gray"},{"text":"Bloo ","color":"gray","clickEvent":{"action":"open_url","value":"https://twitter.com/Bloo_dev"}},{"text":"2021. Special thanks to: ","color":"gray"},{"text":"SpecialBuilder32 ","color":"gray","clickEvent":{"action":"open_url","value":"https://twitter.com/SpecialBuilder"}},{"text":"and ","color":"gray"},{"text":"ToffeeMax","color":"gray","clickEvent":{"action":"open_url","value":"https://twitter.com/ToffeeMax"}}]
