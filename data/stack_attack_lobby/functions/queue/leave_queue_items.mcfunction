...
tag @s remove sat_leave_queue

# update amount of players in queue
scoreboard players remove players_in_queue sat_data 1

# notify self
tellraw @s ["",{"text":"["},{"text":"S","color":"yellow"},{"text":"tack ","color":"light_purple"},{"text":"A","color":"blue"},{"text":"ttack","color":"green"},{"text":"] ","color":"none"},{"text":"You have left the lobby. You have items on you.","color":"red"}]
