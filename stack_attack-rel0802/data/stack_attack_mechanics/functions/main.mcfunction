...
execute if score arenas_active sat_data matches 1.. as @e[type=area_effect_cloud,tag=sat_arena,scores={sat_arena_state=1..3}] at @s align xyz positioned ~ ~2 ~ run function stack_attack_arena:round/timer
